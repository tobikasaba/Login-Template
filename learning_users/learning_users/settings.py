...
# the first two, Argon2 or BCryptSHA256 offer the best security practices in modern systems
PASSWORD_HASHERS = [
...
# used to validate the type of passwords that can be used on the site
AUTH_PASSWORD_VALIDATORS = [
    {
        # can't use username as your password
        'NAME': 'django.contrib.auth.password_validation.UserAttributeSimilarityValidator',
    },
    {
        'NAME': 'django.contrib.auth.password_validation.MinimumLengthValidator',
        # minimum length that the password can be
